...
const HeroSection = ({ setCoin }) => {
  return (
    <section
      className="max-w-7xl mx-auto w-[97%] px-10 py-17 rounded-3xl bg-black text-white space-y-7 bg-cover bg-center"
      style={{
    ...
    >
      ...
      <button
        ...
        className="btn mx-auto block text-black font-bold bg-[#E7FE29] border-none rounded-lg outline-1 outline-[#E7FE29] outline-offset-7"
      >
        Claim Free Credit
      </button>
    </section>
